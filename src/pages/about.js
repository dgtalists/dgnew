...
export default function About() {
  ...
  return (
    <>
      <Head>
        <title>About Us | Dgtalists' Vision for Digital Transformation</title>
        <meta name="description" content="Explore the About Us page of Dgtalists to see how we drive innovation. Meet the minds shaping smart digital strategies—start your journey with us today!" />
