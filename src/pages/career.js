...
export default function Career() {
  ...
  return (
    <>
      <Head>
        <title>Careers at Dgtalists | Join Our Innovative Tech Team</title>
        <meta name="description" content="At Dgtalists, we build careers rooted in innovation, collaboration, and continuous growth. Explore opportunities to join our dynamic team and shape the future of digital transformation." />
