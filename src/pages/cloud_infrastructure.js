          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-9">
              <div className={styles.sectionLeft}>
                <h1>
                  <AnimatedText
                    text={"Empowering Your Business with Scalable, Secure Cloud Infrastructure"}
                    highlightText={"Scalable, Secure"}
                  />
                </h1>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className={styles.aboutRight}>
                ...
                <h4 className={styles.title}>
                  <AnimatedText
                    text={
                      "Powering Digital Transformation through Cloud and Infrastructure"
                    }
                    highlightText={"Digital Transformation"}
                  />
                </h4>
                <p>
                  In today’s digital-first world, a strong cloud and infrastructure foundation is essential for agility and growth. Our expert team designs and manages scalable cloud environments, robust infrastructure, and seamless migrations tailored to your unique business needs. From cloud strategy to security and DevOps automation, we help you build a resilient and efficient IT backbone that fuels innovation and long-term success.
                </p>
