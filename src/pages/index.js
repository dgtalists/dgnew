...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Dgtalists | Innovative Digital Solutions with Proven ROI</title>
        <meta name="description" content="Unlock ROI with Dgtalists—experts in web, mobile apps, and digital marketing. Drive growth with smart solutions. Let's build your digital future! " />
