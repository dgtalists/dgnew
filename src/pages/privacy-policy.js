...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Dgtalists Solutions Pvt. Ltd.</title>
        <meta name="description" content="Learn how Dgtalists Solutions Pvt. Ltd. collects, uses, and protects your personal information. Our privacy policy ensures transparency and data security." />
