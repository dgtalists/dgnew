...
export default function Customsoftware() {
  ...
  return (
    <>
      <Head>
        <title>Strategy & Consulting</title>
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-9">
              <div className={styles.sectionLeft}>
                <h1>
                  <AnimatedText
                    text={"From Vision to Code: Strategic Software Consulting"}
                    highlightText={"Strategic Software"}
                  />
                </h1>
              </div>
            </div>
              ...
              <div className={styles.aboutRight}>
                ...
                <h4 className={styles.title}>
                  <AnimatedText
                    ...
                    highlightText={"Business Goals"}
                  />
                </h4>
                <p>
                  At DGTALISTS, We help businesses define clear digital strategies and make smarter technology decisions. Our consulting services bridge the gap between business goals and technical execution, ensuring every project is aligned for success.
                </p>
